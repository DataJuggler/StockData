...
namespace ApplicationLogicComponent.DataOperations
{
    ...
    public class IndustryMethods
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new Creates a new 'IndustryMethods' object.
        /// </summary>
        public IndustryMethods(DataManager dataManagerArg)
        {
            // Save Argument
        ...
        #region Methods
            ...
            internal PolymorphicObject DeleteIndustry(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteIndustryProc != null)
                    {
                        ...
                        bool deleted = this.DataManager.IndustryManager.DeleteIndustry(deleteIndustryProc, dataConnector);
            ...
            internal PolymorphicObject FetchAll(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if(fetchAllProc!= null)
                {
                    ...
                    industryListCollection = this.DataManager.IndustryManager.FetchAllIndustrys(fetchAllProc, dataConnector);
            ...
            /// <param name='List<PolymorphicObject>'>The 'Industry' to delete.
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject FindIndustry(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Industry != null)
                    {
                        ...
                        if(findIndustryProc != null)
                        {
                            ...
                            industry = this.DataManager.IndustryManager.FindIndustry(findIndustryProc, dataConnector);
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject InsertIndustry(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Industry != null)
                    {
                        ...
                        if(insertIndustryProc != null)
                        {
                            ...
                            returnObject.IntegerValue = this.DataManager.IndustryManager.InsertIndustry(insertIndustryProc, dataConnector);
                        }
            ...
            internal PolymorphicObject UpdateIndustry(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Industry != null)
                    {
                        ...
                        if(updateIndustryProc != null)
                        {
                            ...
                            bool saved = this.DataManager.IndustryManager.UpdateIndustry(updateIndustryProc, dataConnector);
