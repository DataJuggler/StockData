...
namespace ApplicationLogicComponent.DataOperations
{
    ...
    /// </summary>
    public class IndustryHistoryMethods
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new Creates a new 'IndustryHistoryMethods' object.
        /// </summary>
        public IndustryHistoryMethods(DataManager dataManagerArg)
        {
            // Save Argument
        ...
        #region Methods
            ...
            internal PolymorphicObject DeleteIndustryHistory(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteIndustryHistoryProc != null)
                    {
                        ...
                        bool deleted = this.DataManager.IndustryHistoryManager.DeleteIndustryHistory(deleteIndustryHistoryProc, dataConnector);
            ...
            internal PolymorphicObject FetchAll(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if(fetchAllProc!= null)
                {
                    ...
                    industryHistoryListCollection = this.DataManager.IndustryHistoryManager.FetchAllIndustryHistorys(fetchAllProc, dataConnector);
            ...
            /// <param name='List<PolymorphicObject>'>The 'IndustryHistory' to delete.
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject FindIndustryHistory(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as IndustryHistory != null)
                    {
                        ...
                        if(findIndustryHistoryProc != null)
                        {
                            ...
                            industryHistory = this.DataManager.IndustryHistoryManager.FindIndustryHistory(findIndustryHistoryProc, dataConnector);
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject InsertIndustryHistory(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as IndustryHistory != null)
                    {
                        ...
                        if(insertIndustryHistoryProc != null)
                        {
                            ...
                            returnObject.IntegerValue = this.DataManager.IndustryHistoryManager.InsertIndustryHistory(insertIndustryHistoryProc, dataConnector);
                        }
            ...
            internal PolymorphicObject UpdateIndustryHistory(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as IndustryHistory != null)
                    {
                        ...
                        if(updateIndustryHistoryProc != null)
                        {
                            ...
                            bool saved = this.DataManager.IndustryHistoryManager.UpdateIndustryHistory(updateIndustryHistoryProc, dataConnector);
