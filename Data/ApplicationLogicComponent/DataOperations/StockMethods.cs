...
namespace ApplicationLogicComponent.DataOperations
{
    ...
    public class StockMethods
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new Creates a new 'StockMethods' object.
        /// </summary>
        public StockMethods(DataManager dataManagerArg)
        {
            // Save Argument
        ...
        #region Methods
            ...
            internal PolymorphicObject DeleteStock(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteStockProc != null)
                    {
                        ...
                        bool deleted = this.DataManager.StockManager.DeleteStock(deleteStockProc, dataConnector);
            ...
            internal PolymorphicObject FetchAll(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if(fetchAllProc!= null)
                {
                    ...
                    stockListCollection = this.DataManager.StockManager.FetchAllStocks(fetchAllProc, dataConnector);
            ...
            /// <param name='List<PolymorphicObject>'>The 'Stock' to delete.
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject FindStock(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Stock != null)
                    {
                        ...
                        if(findStockProc != null)
                        {
                            ...
                            stock = this.DataManager.StockManager.FindStock(findStockProc, dataConnector);
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject InsertStock(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Stock != null)
                    {
                        ...
                        if(insertStockProc != null)
                        {
                            ...
                            returnObject.IntegerValue = this.DataManager.StockManager.InsertStock(insertStockProc, dataConnector);
                        }
            ...
            internal PolymorphicObject UpdateStock(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Stock != null)
                    {
                        ...
                        if(updateStockProc != null)
                        {
                            ...
                            bool saved = this.DataManager.StockManager.UpdateStock(updateStockProc, dataConnector);
