...
namespace ApplicationLogicComponent.Controllers
{
    ...
    public class StockStreakViewController
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new 'StockStreakViewController' object.
        /// </summary>
        public StockStreakViewController(ErrorHandler errorProcessorArg, ApplicationController appControllerArg)
        {
            // Save Arguments
        ...
        #region Methods
            ...
            private List<PolymorphicObject> CreateStockStreakViewParameter(StockStreakView stockStreakView)
            {
                // Initial Value
            ...
            #region FetchAll(StockStreakView tempStockStreakView)
            /// <summary>
            ...
            public List<StockStreakView> FetchAll(StockStreakView tempStockStreakView)
            {
                // Initial value
                ...
                try
                {
                    ...
                    ApplicationController.DataOperationMethod fetchAllMethod = this.AppController.DataBridge.DataOperations.StockStreakViewMethods.FetchAll;
