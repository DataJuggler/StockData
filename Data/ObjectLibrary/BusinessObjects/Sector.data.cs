    ...
    public partial class Sector
    {
        ...
        #region Methods
            ...
            public string GenerateInsertSQL()
            {
                ...
                // Set the return Value
                string insertSQL = "INSERT INTO [Sector] (Advancers,AveragePercentChange,Decliners,LastUpdated,Name,NumberStocks,Score,Streak) VALUES (" + valuesList + ") " + Environment.NewLine + "SELECT SCOPE_IDENTITY()" + Environment.NewLine;
