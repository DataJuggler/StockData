    ...
    public partial class SectorHistory
    {
        ...
        #region Methods
            ...
            public string GenerateInsertSQL()
            {
                ...
                // Set the return Value
                string insertSQL = "INSERT INTO [SectorHistory] (Advancers,AveragePercentChange,Date,Decliners,Score,SectorId,Streak) VALUES (" + valuesList + ") " + Environment.NewLine + "SELECT SCOPE_IDENTITY()" + Environment.NewLine;
