...
namespace DataAccessComponent.DataGateway
{
    ...
    public class Gateway
    {
        ...
        #region Methods
            ...
            /// <summary>
            /// This method is used to load 'StockDay' objects by IndustryProcessedAndSectorProcessed
            /// </summary>
            public List<StockDay> LoadStockDaysThatNeedsProcessing(bool industryProcessed, bool sectorProcessed)
            {
                ...
                // Set the value for LoadByIndustryProcessedAndSectorProcessed to true
                tempStockDay.LoadByIndustryProcessedAndSectorProcessed = true;
