...
namespace DataAccessComponent.DataOperations
{
    ...
    /// </summary>
    public static class SectorMethods
    {
        ...
        #region Methods
            ...
            internal static PolymorphicObject DeleteSector(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteSectorProc != null)
                    {
                        ...
                        bool deleted = SectorManager.DeleteSector(deleteSectorProc, dataConnector);
            ...
            internal static PolymorphicObject FetchAll(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if(fetchAllProc!= null)
                {
                    ...
                    sectorListCollection = SectorManager.FetchAllSectors(fetchAllProc, dataConnector);
            ...
            /// <param name='List<PolymorphicObject>'>The 'Sector' to delete.
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal static PolymorphicObject FindSector(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Sector != null)
                    {
                        ...
                        if(findSectorProc != null)
                        {
                            ...
                            sector = SectorManager.FindSector(findSectorProc, dataConnector);
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal static PolymorphicObject InsertSector(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Sector != null)
                    {
                        ...
                        if(insertSectorProc != null)
                        {
                            ...
                            returnObject.IntegerValue = SectorManager.InsertSector(insertSectorProc, dataConnector);
                        }
            ...
            internal static PolymorphicObject UpdateSector(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Sector != null)
                    {
                        ...
                        if(updateSectorProc != null)
                        {
                            ...
                            bool saved = SectorManager.UpdateSector(updateSectorProc, dataConnector);
