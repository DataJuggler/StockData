...
namespace DataAccessComponent.DataOperations
{
    ...
    /// </summary>
    public static class SectorHistoryMethods
    {
        ...
        #region Methods
            ...
            internal static PolymorphicObject DeleteSectorHistory(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteSectorHistoryProc != null)
                    {
                        ...
                        bool deleted = SectorHistoryManager.DeleteSectorHistory(deleteSectorHistoryProc, dataConnector);
            ...
            internal static PolymorphicObject FetchAll(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if(fetchAllProc!= null)
                {
                    ...
                    sectorHistoryListCollection = SectorHistoryManager.FetchAllSectorHistorys(fetchAllProc, dataConnector);
            ...
            /// <param name='List<PolymorphicObject>'>The 'SectorHistory' to delete.
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal static PolymorphicObject FindSectorHistory(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as SectorHistory != null)
                    {
                        ...
                        if(findSectorHistoryProc != null)
                        {
                            ...
                            sectorHistory = SectorHistoryManager.FindSectorHistory(findSectorHistoryProc, dataConnector);
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal static PolymorphicObject InsertSectorHistory(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as SectorHistory != null)
                    {
                        ...
                        if(insertSectorHistoryProc != null)
                        {
                            ...
                            returnObject.IntegerValue = SectorHistoryManager.InsertSectorHistory(insertSectorHistoryProc, dataConnector);
                        }
            ...
            internal static PolymorphicObject UpdateSectorHistory(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as SectorHistory != null)
                    {
                        ...
                        if(updateSectorHistoryProc != null)
                        {
                            ...
                            bool saved = SectorHistoryManager.UpdateSectorHistory(updateSectorHistoryProc, dataConnector);
