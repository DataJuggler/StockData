...
namespace DataAccessComponent.DataOperations
{
    ...
    /// </summary>
    public static class DoNotTrackMethods
    {
        ...
        #region Methods
            ...
            internal static PolymorphicObject DeleteDoNotTrack(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteDoNotTrackProc != null)
                    {
                        ...
                        bool deleted = DoNotTrackManager.DeleteDoNotTrack(deleteDoNotTrackProc, dataConnector);
            ...
            internal static PolymorphicObject FetchAll(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if(fetchAllProc!= null)
                {
                    ...
                    doNotTrackListCollection = DoNotTrackManager.FetchAllDoNotTracks(fetchAllProc, dataConnector);
            ...
            /// <param name='List<PolymorphicObject>'>The 'DoNotTrack' to delete.
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal static PolymorphicObject FindDoNotTrack(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as DoNotTrack != null)
                    {
                        ...
                        if(findDoNotTrackProc != null)
                        {
                            ...
                            doNotTrack = DoNotTrackManager.FindDoNotTrack(findDoNotTrackProc, dataConnector);
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal static PolymorphicObject InsertDoNotTrack(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as DoNotTrack != null)
                    {
                        ...
                        if(insertDoNotTrackProc != null)
                        {
                            ...
                            returnObject.IntegerValue = DoNotTrackManager.InsertDoNotTrack(insertDoNotTrackProc, dataConnector);
                        }
            ...
            internal static PolymorphicObject UpdateDoNotTrack(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as DoNotTrack != null)
                    {
                        ...
                        if(updateDoNotTrackProc != null)
                        {
                            ...
                            bool saved = DoNotTrackManager.UpdateDoNotTrack(updateDoNotTrackProc, dataConnector);
