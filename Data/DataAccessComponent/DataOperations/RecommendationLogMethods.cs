...
namespace DataAccessComponent.DataOperations
{
    ...
    /// </summary>
    public static class RecommendationLogMethods
    {
        ...
        #region Methods
            ...
            internal static PolymorphicObject DeleteRecommendationLog(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteRecommendationLogProc != null)
                    {
                        ...
                        bool deleted = RecommendationLogManager.DeleteRecommendationLog(deleteRecommendationLogProc, dataConnector);
            ...
            internal static PolymorphicObject FetchAll(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if(fetchAllProc!= null)
                {
                    ...
                    recommendationLogListCollection = RecommendationLogManager.FetchAllRecommendationLogs(fetchAllProc, dataConnector);
            ...
            /// <param name='List<PolymorphicObject>'>The 'RecommendationLog' to delete.
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal static PolymorphicObject FindRecommendationLog(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as RecommendationLog != null)
                    {
                        ...
                        if(findRecommendationLogProc != null)
                        {
                            ...
                            recommendationLog = RecommendationLogManager.FindRecommendationLog(findRecommendationLogProc, dataConnector);
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal static PolymorphicObject InsertRecommendationLog(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as RecommendationLog != null)
                    {
                        ...
                        if(insertRecommendationLogProc != null)
                        {
                            ...
                            returnObject.IntegerValue = RecommendationLogManager.InsertRecommendationLog(insertRecommendationLogProc, dataConnector);
                        }
            ...
            internal static PolymorphicObject UpdateRecommendationLog(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as RecommendationLog != null)
                    {
                        ...
                        if(updateRecommendationLogProc != null)
                        {
                            ...
                            bool saved = RecommendationLogManager.UpdateRecommendationLog(updateRecommendationLogProc, dataConnector);
