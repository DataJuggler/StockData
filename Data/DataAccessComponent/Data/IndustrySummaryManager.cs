...
namespace DataAccessComponent.Data
{
    ...
    public class IndustrySummaryManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<IndustrySummary> FetchAllIndustrySummarys(FetchAllIndustrySummarysStoredProcedure fetchAllIndustrySummarysProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allIndustrySummarysDataSet = DataHelper.LoadDataSet(fetchAllIndustrySummarysProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allIndustrySummarysDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allIndustrySummarysDataSet);
