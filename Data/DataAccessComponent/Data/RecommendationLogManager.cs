...
namespace DataAccessComponent.Data
{
    ...
    public class RecommendationLogManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static bool DeleteRecommendationLog(DeleteRecommendationLogStoredProcedure deleteRecommendationLogProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = DataHelper.DeleteRecord(deleteRecommendationLogProc, databaseConnector);
                }
            ...
            /// </summary>
            public static List<RecommendationLog> FetchAllRecommendationLogs(FetchAllRecommendationLogsStoredProcedure fetchAllRecommendationLogsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allRecommendationLogsDataSet = DataHelper.LoadDataSet(fetchAllRecommendationLogsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allRecommendationLogsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allRecommendationLogsDataSet);
            ...
            /// </summary>
            public static RecommendationLog FindRecommendationLog(FindRecommendationLogStoredProcedure findRecommendationLogProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet recommendationLogDataSet = DataHelper.LoadDataSet(findRecommendationLogProc, databaseConnector);

                    // Verify DataSet Exists
                    if(recommendationLogDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataRow row = DataHelper.ReturnFirstRow(recommendationLogDataSet);
            ...
            /// </summary>
            public static int InsertRecommendationLog(InsertRecommendationLogStoredProcedure insertRecommendationLogProc, DataConnector databaseConnector)
            {
                // Initial Value
                int newIdentity = -1;
                ...
                {
                    // Execute Non Query
                    newIdentity = DataHelper.InsertRecord(insertRecommendationLogProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public static bool UpdateRecommendationLog(UpdateRecommendationLogStoredProcedure updateRecommendationLogProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = DataHelper.UpdateRecord(updateRecommendationLogProc, databaseConnector);
                }
