...
namespace DataAccessComponent.Data
{
    ...
    public class SectorSummaryManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<SectorSummary> FetchAllSectorSummarys(FetchAllSectorSummarysStoredProcedure fetchAllSectorSummarysProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allSectorSummarysDataSet = DataHelper.LoadDataSet(fetchAllSectorSummarysProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allSectorSummarysDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allSectorSummarysDataSet);
