...
namespace DataAccessComponent.Data
{
    ...
    public class DailyPriceDataViewManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<DailyPriceDataView> FetchAllDailyPriceDataViews(FetchAllDailyPriceDataViewsStoredProcedure fetchAllDailyPriceDataViewsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allDailyPriceDataViewsDataSet = DataHelper.LoadDataSet(fetchAllDailyPriceDataViewsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allDailyPriceDataViewsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allDailyPriceDataViewsDataSet);
