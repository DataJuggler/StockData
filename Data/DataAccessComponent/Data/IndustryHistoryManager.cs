...
namespace DataAccessComponent.Data
{
    ...
    public class IndustryHistoryManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static bool DeleteIndustryHistory(DeleteIndustryHistoryStoredProcedure deleteIndustryHistoryProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = DataHelper.DeleteRecord(deleteIndustryHistoryProc, databaseConnector);
                }
            ...
            /// </summary>
            public static List<IndustryHistory> FetchAllIndustryHistorys(FetchAllIndustryHistorysStoredProcedure fetchAllIndustryHistorysProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allIndustryHistorysDataSet = DataHelper.LoadDataSet(fetchAllIndustryHistorysProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allIndustryHistorysDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allIndustryHistorysDataSet);
            ...
            /// </summary>
            public static IndustryHistory FindIndustryHistory(FindIndustryHistoryStoredProcedure findIndustryHistoryProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet industryHistoryDataSet = DataHelper.LoadDataSet(findIndustryHistoryProc, databaseConnector);

                    // Verify DataSet Exists
                    if(industryHistoryDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataRow row = DataHelper.ReturnFirstRow(industryHistoryDataSet);
            ...
            /// </summary>
            public static int InsertIndustryHistory(InsertIndustryHistoryStoredProcedure insertIndustryHistoryProc, DataConnector databaseConnector)
            {
                // Initial Value
                int newIdentity = -1;
                ...
                {
                    // Execute Non Query
                    newIdentity = DataHelper.InsertRecord(insertIndustryHistoryProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public static bool UpdateIndustryHistory(UpdateIndustryHistoryStoredProcedure updateIndustryHistoryProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = DataHelper.UpdateRecord(updateIndustryHistoryProc, databaseConnector);
                }
