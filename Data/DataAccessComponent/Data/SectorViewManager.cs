...
namespace DataAccessComponent.Data
{
    ...
    public class SectorViewManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<SectorView> FetchAllSectorViews(FetchAllSectorViewsStoredProcedure fetchAllSectorViewsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allSectorViewsDataSet = DataHelper.LoadDataSet(fetchAllSectorViewsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allSectorViewsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allSectorViewsDataSet);
