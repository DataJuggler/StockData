...
namespace DataAccessComponent.Data
{
    ...
    public class StockStreakViewManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<StockStreakView> FetchAllStockStreakViews(FetchAllStockStreakViewsStoredProcedure fetchAllStockStreakViewsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allStockStreakViewsDataSet = DataHelper.LoadDataSet(fetchAllStockStreakViewsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allStockStreakViewsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allStockStreakViewsDataSet);
