...
namespace DataAccessComponent.Data
{
    ...
    public class TopLosingStreakStocksManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<TopLosingStreakStocks> FetchAllTopLosingStreakStocks(FetchAllTopLosingStreakStocksStoredProcedure fetchAllTopLosingStreakStocksProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allTopLosingStreakStocksDataSet = DataHelper.LoadDataSet(fetchAllTopLosingStreakStocksProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allTopLosingStreakStocksDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allTopLosingStreakStocksDataSet);
