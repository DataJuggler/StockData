...
namespace DataAccessComponent.Data
{
    ...
    public class MarketSummaryManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<MarketSummary> FetchAllMarketSummarys(FetchAllMarketSummarysStoredProcedure fetchAllMarketSummarysProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allMarketSummarysDataSet = DataHelper.LoadDataSet(fetchAllMarketSummarysProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allMarketSummarysDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allMarketSummarysDataSet);
