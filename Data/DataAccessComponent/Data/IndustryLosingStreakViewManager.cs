...
namespace DataAccessComponent.Data
{
    ...
    public class IndustryLosingStreakViewManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<IndustryLosingStreakView> FetchAllIndustryLosingStreakViews(FetchAllIndustryLosingStreakViewsStoredProcedure fetchAllIndustryLosingStreakViewsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allIndustryLosingStreakViewsDataSet = DataHelper.LoadDataSet(fetchAllIndustryLosingStreakViewsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allIndustryLosingStreakViewsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allIndustryLosingStreakViewsDataSet);
