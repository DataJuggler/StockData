...
namespace DataAccessComponent.Data
{
    ...
    public class TopStreakStocksManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<TopStreakStocks> FetchAllTopStreakStocks(FetchAllTopStreakStocksStoredProcedure fetchAllTopStreakStocksProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allTopStreakStocksDataSet = DataHelper.LoadDataSet(fetchAllTopStreakStocksProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allTopStreakStocksDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allTopStreakStocksDataSet);
