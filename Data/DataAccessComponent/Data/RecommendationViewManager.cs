...
namespace DataAccessComponent.Data
{
    ...
    public class RecommendationViewManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<RecommendationView> FetchAllRecommendationViews(FetchAllRecommendationViewsStoredProcedure fetchAllRecommendationViewsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allRecommendationViewsDataSet = DataHelper.LoadDataSet(fetchAllRecommendationViewsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allRecommendationViewsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allRecommendationViewsDataSet);
