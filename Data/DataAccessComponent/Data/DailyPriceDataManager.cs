...
namespace DataAccessComponent.Data
{
    ...
    public class DailyPriceDataManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static bool DeleteDailyPriceData(DeleteDailyPriceDataStoredProcedure deleteDailyPriceDataProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = DataHelper.DeleteRecord(deleteDailyPriceDataProc, databaseConnector);
                }
            ...
            /// </summary>
            public static List<DailyPriceData> FetchAllDailyPriceDatas(FetchAllDailyPriceDatasStoredProcedure fetchAllDailyPriceDatasProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allDailyPriceDatasDataSet = DataHelper.LoadDataSet(fetchAllDailyPriceDatasProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allDailyPriceDatasDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allDailyPriceDatasDataSet);
            ...
            /// </summary>
            public static DailyPriceData FindDailyPriceData(FindDailyPriceDataStoredProcedure findDailyPriceDataProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet dailyPriceDataDataSet = DataHelper.LoadDataSet(findDailyPriceDataProc, databaseConnector);

                    // Verify DataSet Exists
                    if(dailyPriceDataDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataRow row = DataHelper.ReturnFirstRow(dailyPriceDataDataSet);
            ...
            /// </summary>
            public static int InsertDailyPriceData(InsertDailyPriceDataStoredProcedure insertDailyPriceDataProc, DataConnector databaseConnector)
            {
                // Initial Value
                int newIdentity = -1;
                ...
                {
                    // Execute Non Query
                    newIdentity = DataHelper.InsertRecord(insertDailyPriceDataProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public static bool UpdateDailyPriceData(UpdateDailyPriceDataStoredProcedure updateDailyPriceDataProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = DataHelper.UpdateRecord(updateDailyPriceDataProc, databaseConnector);
                }
