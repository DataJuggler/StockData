...
namespace DataAccessComponent.Data
{
    ...
    public class IndustryWinningStreakViewManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<IndustryWinningStreakView> FetchAllIndustryWinningStreakViews(FetchAllIndustryWinningStreakViewsStoredProcedure fetchAllIndustryWinningStreakViewsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allIndustryWinningStreakViewsDataSet = DataHelper.LoadDataSet(fetchAllIndustryWinningStreakViewsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allIndustryWinningStreakViewsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allIndustryWinningStreakViewsDataSet);
