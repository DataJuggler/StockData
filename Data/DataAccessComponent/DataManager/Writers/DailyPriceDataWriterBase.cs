        ...
        #region Static Methods
            ...
            internal static SqlParameter[] CreateInsertParameters(DailyPriceData dailyPriceData)
            {
                ...
                if(dailyPriceData != null)
                {
                    ...
                    // Create [MostRecent] parameter
                    param = new SqlParameter("@MostRecent", dailyPriceData.MostRecent);
                    ...
                    param = new SqlParameter("@PercentChange", dailyPriceData.PercentChange);

                    // set parameters[6]
                    parameters[6] = param;

                    // Create [PriceUnchanged] parameter
                    param = new SqlParameter("@PriceUnchanged", dailyPriceData.PriceUnchanged);
            ...
            internal static SqlParameter[] CreateUpdateParameters(DailyPriceData dailyPriceData)
            {
                ...
                if(dailyPriceData != null)
                {
                    ...
                    // Create parameter for [MostRecent]
                    param = new SqlParameter("@MostRecent", dailyPriceData.MostRecent);
                    ...
                    // Create parameter for [PriceUnchanged]
                    param = new SqlParameter("@PriceUnchanged", dailyPriceData.PriceUnchanged);
