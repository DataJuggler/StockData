...
namespace DataAccessComponent.DataManager
{
    ...
    public class IndustryViewManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public List<IndustryView> FetchAllIndustryViews(FetchAllIndustryViewsStoredProcedure fetchAllIndustryViewsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allIndustryViewsDataSet = this.DataHelper.LoadDataSet(fetchAllIndustryViewsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allIndustryViewsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = this.DataHelper.ReturnFirstTable(allIndustryViewsDataSet);
