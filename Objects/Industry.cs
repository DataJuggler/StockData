...
namespace StockData.Objects
{
    ...
    #region class Industry : IExcelerateObject
    public class Industry : IExcelerateObject
    {
        ...
        #region Methods
            ...
            #region Load(Row row)
            /// <summary>
            /// This method loads a Industry object from a Row.
            /// </Summary>
            ...
            /// <summary>
            /// This method loads a list of Industry objects from a Worksheet.
            /// </Summary>
            /// <param name="worksheet">The worksheet which the rows collection will be used to load a list of Industry objects.</param>
            public static List<Industry> Load(Worksheet worksheet)
            {
                // Initial value
                ...
                if ((NullHelper.Exists(worksheet)) && (worksheet.HasRows))
                {
                    ...
                    foreach (Row row in worksheet.Rows)
                    {
                        ...
                        {
                            // Create a new instance of an Industry object.
            ...
            /// <summary>
            /// This method creates the columns for the row to save a new Industry object.
            /// </Summary>
            ...
            #region Save(Row row)
            /// <summary>
            /// This method saves a Industry object back to a Row.
            /// </Summary>
